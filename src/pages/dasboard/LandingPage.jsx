  ...
  return (
    <div className="min-h-screen bg-[#0b0f17] text-slate-100 font-sans antialiased relative selection:bg-indigo-500/30 selection:text-indigo-200">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        <div className="absolute top-[-10%] left-[-10%] w-[50vw] max-w-[600px] h-[50vw] max-h-[600px] bg-indigo-600/20 rounded-full blur-[100px] sm:blur-[140px]" />
        <div className="absolute top-[30%] right-[-5%] w-[45vw] max-w-[500px] h-[45vw] max-h-[500px] bg-purple-600/15 rounded-full blur-[100px] sm:blur-[140px]" />
        <div className="absolute bottom-[-10%] left-[20%] w-[60vw] max-w-[700px] h-[60vw] max-h-[700px] bg-blue-600/15 rounded-full blur-[120px] sm:blur-[160px]" />
      ...
      {/* ========================================== */}
      <nav className="sticky top-2 sm:top-4 z-50 max-w-7xl 2xl:max-w-[1536px] mx-auto px-3 sm:px-6 lg:px-8">
        <div className="backdrop-blur-md bg-white/[0.03] border border-white/10 rounded-2xl px-4 sm:px-6 py-3 flex items-center justify-between shadow-2xl shadow-black/40">
          {/* Logo */}
          <div className="flex items-center gap-2.5 sm:gap-3">
            <div className="p-2 sm:p-2.5 bg-gradient-to-tr from-indigo-500 to-purple-500 rounded-xl shadow-lg shadow-indigo-500/30">
              <FaBagShopping className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
            </div>
            <span className="font-bold text-base sm:text-lg 2xl:text-xl tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white via-slate-200 to-slate-400">
              Lumina<span className="text-indigo-400">Store</span>
            </span>
          </div>

          {/* Search Bar Input (Tampil dari Tablet / MD) */}
          <div className="hidden md:flex items-center gap-2 bg-white/[0.05] border border-white/10 px-3.5 py-1.5 rounded-xl w-60 lg:w-72 2xl:w-96 focus-within:border-indigo-500/50 transition-colors">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <button className="relative p-2.5 rounded-xl bg-white/[0.05] hover:bg-white/[0.1] border border-white/10 text-slate-300 transition-all">
            ...
            <button className="px-3 sm:px-4 py-2 text-xs sm:text-xs 2xl:text-sm font-semibold text-white bg-indigo-600/80 hover:bg-indigo-600 backdrop-blur-sm border border-indigo-400/30 rounded-xl transition-all shadow-lg shadow-indigo-500/20 active:scale-95 whitespace-nowrap">
              Masuk / Daftar
            </button>
          </div>
        </div>
      ...
      {/* HERO SECTION                               */}
      {/* ========================================== */}
      <section className="relative scroll-mt-24 pt-10 sm:pt-16 lg:pt-24 pb-12 sm:pb-16 px-4 max-w-7xl 2xl:max-w-[1536px] mx-auto text-center z-10">
        {/* Badge Hero */}
        <div className="inline-flex items-center gap-2 px-3 py-1 sm:px-3.5 sm:py-1.5 rounded-full backdrop-blur-md bg-white/[0.05] border border-white/10 text-[11px] sm:text-xs 2xl:text-sm font-medium text-indigo-300 mb-6 sm:mb-8 shadow-inner">
