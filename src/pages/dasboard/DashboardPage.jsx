...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-6 p-6 max-w-7xl mx-auto relative">
      ...
      {/* 1. WELCOME BANNER */}
      <div className="bg-gradient-to-r from-slate-900 via-indigo-950 to-slate-900 rounded-2xl p-6 text-white shadow-sm flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
